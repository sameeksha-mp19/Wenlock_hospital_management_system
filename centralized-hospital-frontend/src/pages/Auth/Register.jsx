...
export default function Register() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log(form); // In future: send to backend

    // Redirect only if role is Patient
    if (form.role === "Patient") {
      navigate("/patient/dashboard"); // ← Step 2: Navigate to patient dashboard
    }
  };
    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-4 bg-gradient-to-br from-indigo-100 via-purple-100 to-pink-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 text-gray-800 dark:text-gray-100">
      ...
      >
        ...
        <input
          ...
          value="Patient"
          disabled
          className="w-full p-3 rounded-lg bg-gray-200 dark:bg-gray-700 text-gray-500 dark:text-gray-400 cursor-not-allowed border border-gray-300 dark:border-gray-600"
        />
        <button
          type="submit"
